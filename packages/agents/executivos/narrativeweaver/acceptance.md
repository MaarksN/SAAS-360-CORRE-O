...
# NarrativeWeaver - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com target clarity score e audiências alvo. | Status `success` e schema válido com score de clareza narrativa. | Validar contra `NarrativeWeaverOutputSchema`. | Testes de unit e schema aprovados. |
