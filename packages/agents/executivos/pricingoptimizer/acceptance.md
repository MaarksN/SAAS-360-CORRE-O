...
# PricingOptimizer - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com target win rate lift e segmentos alvo. | Status `success` e schema válido com front de batalha recomendado e sinais de risco. | Validar contra `PricingOptimizerOutputSchema`. | Testes de unit e schema aprovados. |
