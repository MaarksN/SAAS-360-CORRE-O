...
# CulturePulse - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com `targetCultureHealthPct` e segmentos validos. | Status `success` e schema valido com score de saude cultural e riscos de engajamento. | Validar contra `CulturePulseOutputSchema`. | Testes de unit e schema aprovados. |
