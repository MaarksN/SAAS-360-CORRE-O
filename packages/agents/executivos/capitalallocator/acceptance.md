...
# CapitalAllocator - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com target efficiency e segmentos alvo definidos. | Status `success` e schema válido com score de eficiência e realocação. | Validar contra `CapitalAllocatorOutputSchema`. | Testes de unit e schema aprovados. |
