...
# TrendCatcher - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com target growth e segmentos alvo definidos. | Status `success` e schema válido com headline e score de momento da tendência. | Validar contra `TrendCatcherOutputSchema`. | Testes de unit e schema aprovados. |
