...
# BrandGuardian - Acceptance Criteria

| Critério | Input mínimo | Output esperado | Como verificar | Evidência |
|---|---|---|---|---|
| Sucesso Nominal | Request com target brand sentiment e segmentos válidos. | Status `success` e schema válido com score de saúde de marca. | Validar contra `BrandGuardianOutputSchema`. | Testes de unit e schema aprovados. |
